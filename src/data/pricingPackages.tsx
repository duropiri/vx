...
export const ListingMediaPackages = {
  starterPackage: {
    ...
    features: [
      ...
      {
        quantity: "FREE",
        name: "Aerial Drone Images, Blue Sky Enhancements, Custom Property Website, RMS Measurement Report and 2D Floor Plans",
      },
      // {
      //   quantity: "FREE",
  ...
  deluxePackage: {
    ...
    features: [
      ...
      { name: "Top-Dollar Listing Twilight Hero Shot" },
