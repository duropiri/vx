...
export const createGSAPAnimation = (animation: () => gsap.core.Timeline | gsap.core.Tween) => {
...
export const killGSAPAnimation = (animation: gsap.core.Timeline | gsap.core.Tween | null) => {
  if (!animation) return;
