...
export const metadata: Metadata = {
  ...
  description: "Transform your property listings with professional HDR photography, 3D tours, virtual staging, drone footage, and more. Complete listing media packages with 48-hour turnaround and 2X money-back guarantee.",
