      ...
      <div className="relative flex size-full flex-col items-start justify-between gap-[1.5rem]">
        ...
        <p
          className={`pn-regular-16
              max-w-[43.75rem]`}
        >
          3D renderings enable homeowners and renovators to get a clear picture
          of how their renovation project or new construction will look before
          they even begin to break the ground or tear down a wall.
        </p>
      </div>
    </div>
  </div>
